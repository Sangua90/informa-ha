...
(function(){
 ...
 const LIB={
  ...
  Bicipiti:[['incline_support_cable_curl','Curl bicipiti al cavo basso con appoggio inclinato','incline_support_cable_curl','plates'],['dumbbell_curl','Curl con manubri','dumbbell_curl','kg'],['dumbbell_hammer_curl','Hammer curl con manubri','dumbbell_hammer_curl','kg'],['reverse_curl','Reverse curl con manubri','reverse_curl','kg']],
