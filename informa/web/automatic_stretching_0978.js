...
(function(){
 ...
 function trimStrength(strength,minutes){const perExercise=8,minimum=Number(IF50.time)>=50?(IF50.energy==='Bassa'?3:4):1;const max=Math.max(minimum,Math.floor(minutes/perExercise));return strength.slice(0,max)}
 ...
 console.log('[INFORMHA_AUTO_STRETCH] version=0.9.78 automatic=1 treadmill_replaces_mobility=1 final_stretch=1 total_time_budget=1 fifty_minute_strength_minimum=1');
})();
