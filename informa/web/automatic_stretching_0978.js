...
(function(){
 ...
 function trimStrength(strength,minutes){const selected=Math.max(2,Math.min(5,Number(IF50.exerciseCount)||4));return strength.slice(0,selected)}
 ...
 console.log('[INFORMHA_AUTO_STRETCH] version=0.9.78 automatic=1 treadmill_replaces_mobility=1 final_stretch=1 total_time_budget=1 selected_exercise_count_preserved=1');
})();
