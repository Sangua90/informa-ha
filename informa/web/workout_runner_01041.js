...
(function(){
 ...
 function draw(){
  ...
  if(e.mobility||e.stretching||e.cardio){b.innerHTML='<div class="if1041-kicker">ESERCIZIO '+(ix+1)+' DI '+a.length+'</div><h2>'+e.name+'</h2>';return}
