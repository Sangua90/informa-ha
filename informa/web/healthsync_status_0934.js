...
(function(){
  ...
  function install(){
    ...
    details.innerHTML=`<summary><span class="if921-icon">📱</span><span><b>iPhone / Health Auto Export</b><small>Verifica quali dati salute e attività stanno arrivando.</small></span><strong>›</strong></summary><div class="if921-body" id="if934HealthHost"><div class="sub">Apri la sezione per controllare il collegamento.</div></div>`;
