...
(function(){
 ...
 function ensure(){
  ...
  card.querySelectorAll('[data-if976-stretch]').forEach(b=>{b.classList.toggle('on',b.dataset.if976Stretch===IF50.stretch_mode);b.onclick=()=>{IF50.stretch_mode=b.dataset.if976Stretch;card.querySelectorAll('[data-if976-stretch]').forEach(x=>x.classList.toggle('on',x===b))}});
 }
